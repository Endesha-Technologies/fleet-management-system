...
interface RotateTyresDrawerProps {
  open: boolean;
      ...
      <div className="fixed right-0 top-0 bottom-0 w-full max-w-4xl bg-white shadow-xl z-50 overflow-y-auto flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Rotation Date</label>
              <input 
                type="date" 
             ...
             <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Rotation Scheme</label>
              <select 
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
                value={scheme}
                onChange={handleSchemeChange}
              >
                <option value="Standard Cross">Standard Cross Rotation</option>
          ...
          {/* Notes */}
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">Rotation Notes</label>
            <textarea 
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
              rows={3}
