...
/** Derive initials from user's first and last name. */
    ...
    <header className="sticky top-0 z-50 flex h-16 items-center justify-between bg-white px-6 shadow-md">
      ...
      <div className="hidden md:flex items-center gap-4 flex-1">
        <h2 className="text-xl font-semibold text-gray-800">
          Welcome back, <span className="text-[#020887]">{displayName}</span>
        </h2>
      </div>
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="hidden md:flex items-center gap-3">
          <Avatar className="h-9 w-9 border border-gray-200">
            <AvatarImage src="/avatars/01.png" alt={`@${user?.firstName?.toLowerCase() ?? 'user'}`} />
            <AvatarFallback className="bg-[#020887]/10 text-[#020887]">{initials}</AvatarFallback>
          </Avatar>
