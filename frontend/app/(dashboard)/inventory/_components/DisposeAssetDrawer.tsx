...
import { FormDateInput, FormSelect, FormTextarea, FormNumberInput } from '@/components/ui/form';
import { Plus, Trash2, ChevronLeft } from 'lucide-react';
import type { DisposeAssetDrawerProps, DisposeLineItem } from '../_types';
              ...
              {item.tracking === 'Serial Number' ? (
                ...
                <div className="space-y-2">
                    <FormNumberInput
                      ...
                      description={`Available: ${item.maxQuantity}`}
                    />
                </div>
              )}
          </div>
